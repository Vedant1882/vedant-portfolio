  ...
  return (
    <section id="contact" className="bg-gradient-to-r from-purple-800 to-indigo-800 text-white py-20 px-6">
      <div className="max-w-lg mx-auto text-center">
        ...
        <p className="mb-6 text-gray-200">Have a project or role in mind? Drop a message below!</p>

        <form action="https://formspree.io/f/mnqeylky" method="POST" className="space-y-4">
