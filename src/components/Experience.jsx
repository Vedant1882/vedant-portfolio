            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                    <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
                        <h3 className="text-xl font-semibold text-gray-800">TatvaSoft — Associate Software Engineer</h3>
                        <p className="text-sm text-gray-500">Ahmedabad | Jun 2023 – Present</p>
                    ...
                    <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
                        <h3 className="text-xl font-semibold text-gray-800">TatvaSoft — Intern</h3>
