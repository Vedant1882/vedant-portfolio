        ...
        <section id="projects" className="bg-gray-900 text-white py-20 px-6">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-white/70 backdrop-blur rounded-xl p-6 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition">
                        <h3 className="text-xl font-bold text-gray-800 mb-2">Cafeteria Management</h3>
                        <p className="text-gray-600">
                            QR-based menu and ordering system for mobile phones. Users scan QR codes, view items, and place orders digitally.
                        </p>
                        <p className="text-sm text-gray-500 mt-2 italic">Built with: Java, MySQL</p>
                    </div>

                    <div className="bg-white/70 backdrop-blur rounded-xl p-6 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition">
                        <h3 className="text-xl font-bold text-gray-800 mb-2">Student Portal</h3>
                        <p className="text-gray-600">
